...
# # Aya 101 Out-of-the-Box Evaluation
# This script contains the code to evaluate Aya 101 out-of-the-box on our evaluation benchmarks.
...
# Download and load Aya 101 (with some optimizations)
from transformers import AutoModelForSeq2SeqLM, AutoTokenizer, BitsAndBytesConfig
import torch

model_id = "CohereForAI/aya-101"
output_name = model_id[model_id.rfind('/')+1:]  # Get aya-101 part
...
def infer(jsonl_row):
    ...
    input_ids = tokenizer.encode(messages[0]['content'], return_tensors="pt").to(model.device)
