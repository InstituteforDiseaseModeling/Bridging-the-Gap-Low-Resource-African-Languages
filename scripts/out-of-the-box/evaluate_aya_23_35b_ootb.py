...
# # Aya 23 35B Out-of-the-Box Evaluation
# This script contains the code to evaluate Aya 23 35B out-of-the-box on our evaluation benchmarks.
...
# Please log in to your Hugging Face account and get your read token: https://huggingface.co/settings/tokens
# Then, get access to the Aya 23 35B model here: https://huggingface.co/CohereForAI/aya-23-35B
# Finally, enter your Hugging Face read token here:
hf_token = input("Enter Hugging Face read token: ")

import os
os.environ['HF_TOKEN'] = hf_token  # Set appropriate env var
...
# Download and load Aya 23 35B (with some optimizations)
from transformers import AutoTokenizer, AutoModelForCausalLM, BitsAndBytesConfig
import torch

model_id = "CohereForAI/aya-23-35B"
output_name = model_id[model_id.rfind('/')+1:]  # Get aya-23-35B
...
def infer(jsonl_row):
    ...
    response = response[response.rfind('<|CHATBOT_TOKEN|>')+len('<|CHATBOT_TOKEN|>'):]
    return response
